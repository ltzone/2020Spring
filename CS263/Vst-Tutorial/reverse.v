...
Definition _w : ident := 56%positive.
...
Definition f_reverse := {|
  ...
  fn_body :=
(Ssequence
  (Sset _w (Ecast (Econst_int (Int.repr 0) tint) (tptr (Tstruct _list noattr))))
  (Ssequence
...
(_reverse :: ___builtin_debug :: ___builtin_write32_reversed ::
